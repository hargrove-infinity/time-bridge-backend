...
const ERROR_DEFINITIONS_EMAIL_SERVICE = {
  SEND_EMAIL_FAILED: {
    ...
    description: "Sending email is failed.",
  },
};

const ERROR_DEFINITIONS_EMAIL_CONFIRMATION_REPOSITORY = {
  CREATE_EMAIL_CONFIRMATION_DATABASE_ERROR: {
...
export const ERROR_DEFINITIONS = {
  ...
  ...ERROR_DEFINITIONS_EMAIL_SERVICE,
  ...ERROR_DEFINITIONS_EMAIL_CONFIRMATION_REPOSITORY,
